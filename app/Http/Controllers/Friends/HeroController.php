...
{
    protected $redirect_index = '/friends/heroes/index';

    protected $view_path = 'friends.heroes.';

    protected $pre_uri = '/friends/heroes/';

    protected $modal_name = '英雄令';

    protected $modal;

    public function __construct()
    {
        $this->modal = new HelloFriendsHero();
    }
