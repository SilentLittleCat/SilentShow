...
{
    protected $redirect_index = '/friends/loves/index';

    protected $view_path = 'friends.loves.';

    protected $pre_uri = '/friends/loves/';

    protected $modal_name = '告白';

    protected $modal;

    public function __construct()
    {
        $this->modal = new HelloFriendsLove();
    }
