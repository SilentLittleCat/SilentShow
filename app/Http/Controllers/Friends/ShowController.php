...
{
    protected $redirect_index = '/friends/shows/index';

    protected $view_path = 'friends.shows.';

    protected $pre_uri = '/friends/shows/';

    protected $modal_name = '秀才华';

    protected $modal;

    public function __construct()
    {
        $this->modal = new HelloFriendsShow();
    }
