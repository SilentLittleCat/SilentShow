...
{
    protected $redirect_index = '/friends/travels/index';

    protected $view_path = 'friends.travels.';

    protected $pre_uri = '/friends/travels/';

    protected $modal_name = '难忘旅途';

    protected $modal;

    public function __construct()
    {
        $this->modal = new HelloFriendsTravel();
    }
