                ...
                <div class="col-sm-4">
                    <form method="GET">
                        <div class="input-group">
                            <input type="text" class="form-control input-sm" name="keywords" value="{{ request('keywords') }}" placeholder="输入{{ $model_name }}名称搜索">
            ...
            <div class="box-body row" id="sg-table">
                <table class="table table-hover table-responsive table-striped">
                    <tbody>
                        ...
                        @if($list->count() == 0)
                            <tr>
                                <td colspan="6" class="sg-empty-table-hint">暂无{{ $model_name }}！</td>
                            </tr>
                        @else
